 ...
 <Layout title={`${pokemon.name}`} data-testid={`pokemon-name`}>
      <div >
        <div>
          <div>
            <main>
            <img className="w-100 h-100" src= {pokemon.sprites.other?.dream_world.front_default || "/no-image.png"} alt={pokemon.name}  />
             </main>
          </div>
        </div>
        ...
        <div>
          <div>
            ...
            <main>
              <h2>Sprites:</h2>
              <div>
              <img className="w-100 h-100" src={pokemon.sprites.front_default} alt={pokemon.name} width={200} height={200} />
                <img className="w-100 h-100" src={pokemon.sprites.back_default} alt={pokemon.name} width={200} height={200} />
                <img className="w-100 h-100" src={pokemon.sprites.front_shiny} alt={pokemon.name} width={200} height={200} />
                <img className="w-100 h-100" src={pokemon.sprites.back_shiny} alt={pokemon.name} width={200} height={200} />
              </div>
            </main>
          </div>
        </div>
